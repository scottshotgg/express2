...
func (b *Builder) AddPrimitive(key string, value *Node) (TypeValue, error) {
	...
	default:
		return nil, errors.New("Type not defined in AddPrimitive:", value.Kind)
	}

	b.TypeMap[key] = &TypeValue{
		Type: PrimitiveValue,
		Kind: value.Kind,
	}

	// I don't care about the extra hash cost rn
	return b.TypeMap[key], nil
}

func (b *Builder) AddReapeated(key string, value *Node) error {
	return errors.New("Not implemented")
}

func (b *Builder) AddStructured(key string, value *Node) error {
	return errors.New("Not implemented")
}
