...
func (b *Builder) AddPrimitive(key string, value *TypeValue) error {
	b.TypeMap[key] = 
}

func (b *Builder) AddReapeated(key string, value *TypeValue) error {
	return errors.New("Not implemented")
}

func (b *Builder) AddStructured(key string, value *TypeValue) error {
	return errors.New("Not implemented")
}
